...
<div class="contain">
  <?php echo'<img id="ind_img" src="assets/medi.jpg" alt="Snow" style="width:100%">' ;?>
  <p class="p2"><strong>PROVIDE HELPING HANDS</strong></p>
  <p class="p3">YOUR SOME HELP MAKE SOMEONE'S LIFE BETTER</p>
  <p class="p1"><strong>PLEASE GIVE SOME HELP</strong></p>
